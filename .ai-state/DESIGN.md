...
- **`dec-draft-9f240fc7`** — Bi-partite anchor model: an anchor of record is the historical
...
- **`dec-draft-b3775b57`** — `notes/<topic>/` storage: a new reserved top-level folder family
...
- **`dec-draft-90eda308`** — Eval bridge (`curate_example`, not `SuggestionRecord` reuse or
