...
| **MCP tool surface** — 25 flat tools + 9 action dispatchers + `open_dashboard` | `src/knotica/mcp_server/tools_dispatch_*.py`, `src/knotica/mcp_server/dispatch_telemetry.py` |
