...
- Autonomous loop → `src/knotica/core/loop.py` (spine), `loop_state.py`, `loop_heartbeat.py`,
  ...
  `loop_factory.py`, `branch_*.py`, `loop_promote.py`, `loop_retry_backoff.py`,
  `loop_cadence_config.py`, `best_effort.py`; CLI entry `src/knotica/cli/loop.py`.
